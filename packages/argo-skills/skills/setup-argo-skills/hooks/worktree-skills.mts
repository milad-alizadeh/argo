...
import { gitArgs, parseWorktreeAdd } from './worktree-add-parse.mts'
...
function worktreeAddDirectories(command: string): string[] {
...
export function copySkillsAfterWorktreeAdd({
  toolName,
  toolInput = {},
  cwd = process.cwd(),
}: {
