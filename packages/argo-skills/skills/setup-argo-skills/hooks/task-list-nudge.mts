...
import { readStdin, underAgent } from './hook-io.mts'
import { toolCallsIn, writesSessionList } from './transcript-plans.mts'
...
export function decide({ hasList, nudges }: { hasList: boolean; nudges: number }): boolean {
...
export function transcriptHasList(file: string | undefined): boolean {
