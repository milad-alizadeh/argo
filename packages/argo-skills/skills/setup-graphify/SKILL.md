---
name: setup-graphify
description: Install graphify and a self-maintaining committed knowledge graph — refreshed inside every commit, deterministically named, code-only, conflict-free across worktrees.
