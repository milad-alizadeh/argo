...
description: Turn the arithmetic half of the house rules — length, complexity, parameter count, escape hatches, duplication — into build failures in whatever linter the repo already runs.
