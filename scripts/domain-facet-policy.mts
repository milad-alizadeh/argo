/** The runtime a source file belongs to. Every rule in this file is keyed by one. */
export type Facet = 'shared' | 'contract' | 'main' | 'preload' | 'renderer' | 'harness'

/** What one facet may reach. */
export type FacetPolicy = {
  refusesNode: boolean
  refusesElectron: boolean
  refusesReact: boolean
  privilegedRoots: string[]
}
...
export const ALLOWED_TARGETS: Record<Facet, Set<string>> = {
...
export const FACET_POLICIES: Record<Facet, FacetPolicy> = {
  shared: {
    refusesNode: true,
