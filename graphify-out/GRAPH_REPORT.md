...
- `firstInChain()` --indirect_call--> `file()`  [INFERRED]
  apps/desktop/src/main/observe/resumeChain.ts → apps/desktop/src/main/observe/observedSession.test.ts
...
Cohesion: 0.23
Nodes (12): file(), running(), deriveSessionStatus(), HALTING_REASONS, hasPendingAsk(), isRecent(), quietStatus(), statusOf() (+4 more)
...
Cohesion: 0.19
Nodes (18): CheckOutputProps, DeliveryLifecycleProps, CHANGES_VIEWS, DELIVERY_TABS, LifecycleNodeProps, NodeDrawerSession, CiDrawerData, ClosedSummary (+10 more)
...
### Community 76 - "react"
Cohesion: 0.16
Nodes (17): ciBody(), commitsBody(), commitsStageBody(), DelegatedRow(), GateAction(), GrowRow(), NodeDrawer(), NodeDrawerProps (+9 more)

### Community 77 - "react-dom"
Cohesion: 0.16
Nodes (10): parseTranscript(), parseFixture(), agentsOf(), NOW, createTreeBuilder(), parseFixture(), SESSION_CLASSES, SESSION_POSTURES (+2 more)
...
Cohesion: 0.19
Nodes (22): createHub(), observe(), parseFixture(), GradeStatus, resolveTitle(), toAgents(), toObservedSession(), toSessionEvent() (+14 more)
...
Cohesion: 0.10
Nodes (31): AllFilesDiff(), AllFilesDiffFile, Default, Empty, FILES, Story, CommitGroupFile, CONTENT_LABEL (+23 more)
...
### Community 118 - "honesty.ts"
Cohesion: 0.40
Nodes (3): Tier, TIERS, ADR-0008
...
- **Why does `PanelSplitter()` connect `PanelSplitter.stories.tsx` to `Electron Vite`, `Session Row & Button`, `Session State Hub`, `SectionHeader.tsx`?**
  _High betweenness centrality (0.326) - this node is a cross-community bridge._
- **Why does `Observer` connect `Session State Hub` to `sessionFacts.ts`?**
