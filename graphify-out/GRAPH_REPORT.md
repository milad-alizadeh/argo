...
## Corpus Check
- 249 files · ~135,090 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1239 nodes · 2522 edges · 104 communities (72 shown, 32 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d355605`
...
Cohesion: 0.14
Nodes (16): NowLine(), Idle, Live, Story, cn(), twMerge, TYPE_ROLES, SessionPanel() (+8 more)

### Community 5 - "Runtime Dependencies"
Cohesion: 0.06
Nodes (49): LifecycleNodeStatePresentation, Default, Story, ArrowCounterClockwiseIcon, ArrowLineUpIcon, ArrowRightIcon, ArrowsClockwiseIcon, ArrowsLeftRightIcon (+41 more)
...
Cohesion: 0.19
Nodes (12): ROSTER_ICON, StatusIcon(), AllIcons, Default, Story, ROSTER_ICONS, ROSTER_TONES, RosterIcon (+4 more)

### Community 15 - "Electron Toolkit TSConfig"
Cohesion: 0.23
Nodes (15): CheckOutputProps, ciBody(), NodeDrawer(), NodeDrawerProps, NodeDrawerSession, mergeBody(), prBody(), closedBody() (+7 more)
...
Cohesion: 0.19
Nodes (14): CommitGroup(), CommitGroupFile, Default, FILES, Story, Uncommitted, FileChangeKind, FileDiff() (+6 more)
...
Cohesion: 0.22
Nodes (13): AccentCard(), AccentCardHeader(), AccentCardTone, accentCardVariants, Blocking, Landed, Story, Tones (+5 more)

### Community 48 - "sessionFacts.ts"
Cohesion: 0.06
Nodes (38): ConciergeDock(), ConciergeDockProps, ErrorState, Idle, Inactive, Listening, ORB_STATES, Playground (+30 more)
...
Cohesion: 0.22
Nodes (9): CHANGES_VIEWS, DELIVERY_TABS, DeliveryTabs(), isChangesView(), isDeliveryTab(), Default, Story, ToggleGroup() (+1 more)
...
Cohesion: 0.12
Nodes (19): CONTENT_LABEL, Delivery(), DeliveryCommitGroup, DeliveryProps, ALL_FILES, ArtifactsTab, ByCommit, COMMIT_GROUPS (+11 more)
...
Cohesion: 0.19
Nodes (11): CHECK_LABEL, CheckOutput(), LOCAL_CHECKS, LocalCheck, Default, EveryCheck, MultilineFeed, Story (+3 more)
...
Cohesion: 0.21
Nodes (11): DeliveryLifecycle(), DeliveryLifecycleProps, TERMINAL_PRESENTATION, LifecycleNode(), LifecycleNodeProps, NODE_LABEL, LIFECYCLE_NODE_STATE, PrAnchor() (+3 more)
...
Cohesion: 0.31
Nodes (7): AllFilesDiff(), AllFilesDiffFile, Default, Empty, FILES, Story, DiffHunkLine
...
Cohesion: 0.16
Nodes (12): App(), DEFAULT_PANEL_UI, ADR-0005, root, SessionScreen(), buildSessionPanel(), DEFAULT_UI, sessionFrom() (+4 more)
...
Cohesion: 0.32
Nodes (5): IconButton(), PanelHeader(), Default, LeftOnly, Story

### Community 86 - "deliveryState"
Cohesion: 0.36
Nodes (5): deliveryState, HEAD_STATUS, rosterStatus, TERMINAL_STATUS, row()

### Community 87 - "PrChecksList.tsx"
Cohesion: 0.33
Nodes (5): CiCard(), CiCardProps, Default, Story, WithoutTrailing
...
Cohesion: 0.54
Nodes (5): DelegatedRow(), GateAction(), GrowRow(), defaultElement(), Text()
...
Cohesion: 0.38
Nodes (5): reviewBody(), reviewRoundLine(), ReviewRoundView, Button(), ArrowBendDownRightIcon

### Community 93 - "SessionRow.stories.tsx"
Cohesion: 0.17
Nodes (9): EmptyRoster(), Default, Story, SessionRow(), Default, EveryState, Pulsing, Selected (+1 more)

### Community 94 - "SessionScreen.tsx"
Cohesion: 0.39
Nodes (7): SpineEdge, applyResize(), applySnap(), SPINE, SpineLayout, base, useSpineLayout()
...
Cohesion: 0.29
Nodes (5): Default, EveryState, Pulsing, Story, SESSION_STATUS
...
## Knowledge Gaps
- **543 isolated node(s):** `*.css`, `projectRoot`, `config`, `project`, `$schema` (+538 more)
...
- **Why does `TerminalSession` connect `terminalBridge.ts` to `channels.ts`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `cn()` connect `Session Row & Button` to `Runtime Dependencies`, `App Rail Shell`, `Electron Toolkit TSConfig`, `Vitest Browser Playwright`, `Storybook Docs Addon`, `Electron`, `sessionFacts.ts`, `Text.tsx`, `PaneSplitter.stories.tsx`, `icons.stories.tsx`, `badge.stories.tsx`, `ContextGauge.tsx`, `SectionHeader.tsx`, `PanelSplitter.stories.tsx`, `WorkspaceIdentity.tsx`, `Text.tsx`, `BackgroundTasks.stories.tsx`, `ContextGauge.tsx`, `SectionHeader.tsx`, `checkbox.stories.tsx`, `sessionStore.ts`, `Roster.stories.tsx`, `deliveryState`, `PrChecksList.tsx`, `lifecycleNodeState.ts`, `PrChecksList.stories.tsx`, `NowLine.stories.tsx`, `SessionRow.stories.tsx`?**
