...
// `package-manifest.mts`. Without `--write` it compares the package against the checked-in
...
import {
  MANIFEST_PATH,
  type PackageManifestAssertion,
  packageManifestAssertion,
  readPackagedManifest,
} from './package-manifest.mts'
...
function reportDifferences(assertion: PackageManifestAssertion): void {
