...
// empty terminal.
// Restoring it is not the assertion; `assert-packaged-pty.mts` reads the mode off the PACKAGED
...
export function restoreSpawnHelperMode(root: string): string[] {
...
export function productionInstall(): string[] {
