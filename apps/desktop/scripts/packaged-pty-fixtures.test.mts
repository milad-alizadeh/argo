...
import { archOf, extraModuleNames, nativeDirs, unpackedFailures } from './packaged-pty-checks.mts'
import { findSpawnHelpers, restoreSpawnHelperMode, SPAWN_HELPER } from './production-install.mts'
...
function installedNodePty(...parts: string[]): string {
...
function fixtureApp(mode: 'good' | 'bad-mode' | 'no-helper'): string {
