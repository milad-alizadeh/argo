...
import type { MockLinearTeam, MockLinearUser } from './mock-linear'

export const ADA: MockLinearUser = {
  id: 'user-ada',
  name: 'Ada Lovelace',
...
export const TEAM: MockLinearTeam = {
  id: 'team-engine',
  key: 'ENG',
  name: 'Engine',
  visibleTo: [ADA.id],
...
export const HIDDEN: MockLinearTeam = {
  id: 'team-hidden',
  key: 'SEC',
  name: 'Secret',
  visibleTo: [],
