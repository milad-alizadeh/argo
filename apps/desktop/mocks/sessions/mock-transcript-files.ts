...
import { sessionArchivePath } from '@/domains/sessions/main/session-archive-store'
...
// by the CLI Session id, the same shape `domains/sessions/main/session-archive-store.ts` reads and writes.
