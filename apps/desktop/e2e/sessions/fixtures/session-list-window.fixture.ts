...
// other fixture, to push the sessionList's bounded window past SESSION_LIST_PAGE_SIZE. Kept apart from
...
// One more than SESSION_LIST_PAGE_SIZE, so the first SessionList page always leaves at least one of these
...
// `windowFiller<COUNT - 1>` the oldest, mirroring the recency order the SessionList reads by.
