...
const story = (change: Partial<ProjectSetupSnapshot>): Story => ({
...
export const ManualSetup = story({ screen: 'manual', manualSource: '{\n  "targets": {}\n}' })
...
export const Cancelling = story({ screen: 'cancelling', attempt, activeEffect: 'planning' })
...
export const Finalizing = story({ screen: 'finalizing', attempt, finalDiff: 'diff' })
export const Deferred = story({ screen: 'deferred' })
export const Ready = story({ screen: 'ready' })
