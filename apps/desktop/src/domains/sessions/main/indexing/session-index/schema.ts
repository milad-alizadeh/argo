// The Session index is a rebuildable cache and never a source of truth: Harness transcript files stay
...
//
// One row per Harness naming how far background backfill has walked into older history: the newest
