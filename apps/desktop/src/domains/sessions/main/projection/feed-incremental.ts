...
import type { ToolEvidence, ToolResult } from '@/domains/sessions/contract/model/tool-feed'
import { groupedRowIndexes, groupToolRuns } from '@/domains/sessions/contract/model/tool-groups'
