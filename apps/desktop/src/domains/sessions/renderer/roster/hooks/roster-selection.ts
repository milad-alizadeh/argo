...
export const EMPTY_ROSTER_SELECTION: RosterSelection = { ids: new Set(), anchor: null }
...
// than starting a new one. `order` is every row currently on screen, in the order the roster draws
