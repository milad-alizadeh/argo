...
// A sentinel row scrolling into view is the trigger to fetch its page's continuation; the Session list and
...
// is mounted and counted as reached. The Session list then grew a page before the reader had scrolled at
