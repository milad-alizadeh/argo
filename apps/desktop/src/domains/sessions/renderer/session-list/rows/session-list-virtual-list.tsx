...
export type SessionListItemOrPending = SessionListItem | PendingSession

function idOf(session: SessionListItemOrPending): string {
  return 'argoId' in session ? session.argoId : session.id
}

function titleOf(session: SessionListItemOrPending, newSession: string): string {
