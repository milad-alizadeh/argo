...
import { referenceMenu } from '@/domains/sessions/renderer/components/composer/references/composer-reference-menu'
import { ComposerReferenceMenuPlugin } from '@/domains/sessions/renderer/components/composer/references/composer-reference-menu-plugin'
import { ComposerReferenceNode } from '@/domains/sessions/renderer/components/composer/references/composer-reference-node'
import { ComposerReferencePlugin } from '@/domains/sessions/renderer/components/composer/references/composer-reference-plugin'
import { ComposerTicketReferenceNode } from '@/domains/sessions/renderer/components/composer/references/composer-ticket-reference-node'
import { ComposerTicketReferencePlugin } from '@/domains/sessions/renderer/components/composer/references/composer-ticket-reference-plugin'
import { SendOnEnterPlugin } from '@/domains/sessions/renderer/components/composer/session-composer-enter'
import {
  composerNodes,
  composerTransformers,
  MarkdownPastePlugin,
  MarkdownTypingShortcutPlugin,
} from '@/domains/sessions/renderer/components/composer/session-composer-markdown'
      ...
      <RichTextPlugin
        ...
        contentEditable={
          <ContentEditable
            ...
            aria-placeholder={t('composer.placeholder')}
