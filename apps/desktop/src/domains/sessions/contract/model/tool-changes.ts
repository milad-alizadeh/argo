...
import type { ToolCall, ToolResult } from '@/domains/sessions/contract/model/transcript/transcript'
import { resultText } from '@/domains/sessions/contract/model/transcript/transcript'
