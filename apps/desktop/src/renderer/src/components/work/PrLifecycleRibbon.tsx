...
import { GitMergeIcon, type IconAtom, ProhibitIcon, Text } from '@/components/ui'
...
/**
 * Organism: the Work pane's header and the ONE home of ship-flow state — the five-node
 * strip, its terminal replacement once the PR lands or closes (R8), or nothing at all
 * before the tree has anything to ship (R7).
 */
export function PrLifecycleRibbon({
  model,
  openKey,
  pr,
  className,
}: PrLifecycleRibbonProps): React.JSX.Element | null {
