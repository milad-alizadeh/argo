...
// Molecule: one dispatched Agent in the Activity panel's Actor roster. Static by design — the
// screen's one animation budget belongs to the lifecycle, so a running Agent reads as a word.
