...
import shared from '@/domains/shared/renderer/locales/en.json'
import tickets from '@/domains/tickets/renderer/locales/en.json'
import cockpit from '@/platform/renderer/locales/en.json'
import platform from '@/platform/renderer/locales/en.json'
