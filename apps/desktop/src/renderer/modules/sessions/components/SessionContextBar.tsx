...
export function SessionContextBar({
  ...
  return (
    <div className="@container relative z-0 mx-(--spacing-shell-inset) -mt-2 flex min-w-0 select-none items-center gap-2 rounded-b-xl border bg-card px-3 pt-4 pb-2 shadow-lg shadow-foreground/10 @[40rem]:gap-3 @[40rem]:px-4">
      ...
      <div className="ml-1 hidden shrink-0 items-center gap-1 border-l border-border/60 pl-4 @[40rem]:flex">
        <Button
          aria-label="Compact context"
          disabled={!canCompact || isCompacting}
          onClick={() => void onCompact?.()}
