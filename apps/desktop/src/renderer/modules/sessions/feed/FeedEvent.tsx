import { BellRing, FileInput, SlidersHorizontal, Terminal } from 'lucide-react'
...
export function FeedEvent({ row }: { row: FeedEventRow }) {
  ...
  return (
    <div
      className="flex min-w-0 items-center gap-2 rounded-md bg-muted/60 px-2.5 py-1.5 type-meta"
