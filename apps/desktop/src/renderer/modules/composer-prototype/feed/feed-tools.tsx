...
const CREATED_FILES: ToolRow[] = [
  { label: 'Created attachment-tray.tsx', evidence: 'createdAttachmentTray', icon: FilePenLine },
...
export function FeedMutationExamples({
  ...
  const mutations: ToolRow[] = [
    {
      label: 'Created attachment-tray.tsx',
    ...
    { label: 'Ran an unclassified tool', evidence: 'unclassified', icon: Wrench },
