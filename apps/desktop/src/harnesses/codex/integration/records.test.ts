...
import { assertUserMessage } from '@/harnesses/codex/integration/assert-user-message'
...
// The two record shapes codex-harness 0.147.0 writes for an app-server Turn, trimmed from a live rollout.
