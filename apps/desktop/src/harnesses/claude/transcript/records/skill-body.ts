...
// A user message's `content` is either the raw string the Harness wrote, or (as it is here) a list of
...
// The Skill tool's own result is a fixed placeholder ("Launching skill: X"); the Harness delivers the
