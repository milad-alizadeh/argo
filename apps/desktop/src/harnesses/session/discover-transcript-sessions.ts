...
import { boundIndexedWindow, presentedRows } from '@/harnesses/session/discover-indexed-window'
import {
  discoverSessionsWith,
  historyCompleteFor,
  resolveIdsAgainst,
  searchAgainst,
} from '@/harnesses/session/discover-transcript-window'
import { createFullRecordTracker } from '@/harnesses/session/full-record-tracker'
import { projectRosterRow } from '@/harnesses/session/roster'
import { rosterMetadata } from '@/harnesses/session/roster-metadata'
import type {
  BackfillProgress,
  SessionIndex,
  TranscriptPath,
} from '@/harnesses/session/session-index-contract'
import { createTitleLedger } from '@/harnesses/session/title-ledger'
import {
  createFileReader,
...
} from '@/harnesses/session/transcript-window'
