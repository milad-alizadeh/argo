/// What Argo learned when it asked a code host what a Work Item number is called (#745).
///
...
public enum TicketReading: Equatable, Sendable {
    case named(String)
    /// Asked, and there is no Work Item behind that number. The number came off a branch name by
