...
/// Why a Work Item write did not land, in the caller's own vocabulary.
///
...
public enum WorkItemWriteError: Error, Equatable {
    ...
    case illegalTransition(from: WorkItemCanonicalState, to: WorkItemCanonicalState)
