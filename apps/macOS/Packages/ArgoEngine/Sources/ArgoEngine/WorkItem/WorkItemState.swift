...
/// The canonical state bucket a Work Item falls in, across every provider (#167).
///
...
/// took the ticket.
public enum WorkItemState: String, Equatable, Sendable, CaseIterable {
    case open
    case claimed
    case resolved
    case ruledOut
    ...
    public init(closure: WorkItemClosure, claimed: Bool) {
        switch closure {
