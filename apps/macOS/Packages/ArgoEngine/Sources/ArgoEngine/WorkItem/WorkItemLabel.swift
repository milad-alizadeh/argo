...
///
/// The colour is the PROVIDER's fact, not Argo's (`CONTEXT.md` L1 · Work Item): a reader who set
...
public struct WorkItemLabel: Equatable, Hashable, Sendable, Identifiable {
