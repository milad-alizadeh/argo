...
protocol SessionChannel {
    ...
    /// What this channel's own surface says about the Turn just typed at it — `unreadable` where
    /// the channel has no surface a person could be looking at (`ComposerEcho`).
