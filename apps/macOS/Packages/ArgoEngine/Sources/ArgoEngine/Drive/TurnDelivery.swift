...
final class TurnDelivery {
    ...
    /// The three things a watch needs of the Hub, which travel together because they are one act
    /// read in three directions: what the Session has written, how to type at it, and where the
    /// answer goes.
    struct Watch {
