...
/// How a Ticket stopped being open, read per-port from the provider's own closure kind
/// (`CONTEXT.md` L1 · Ticket).
///
...
/// to answer.
public enum TicketClosure: Equatable, Sendable, CaseIterable {
    case open
