...
/// Where a Ticket sits in its provider's workflow, in the one vocabulary every provider is read
...
public enum TicketCanonicalState: String, Equatable, Sendable, CaseIterable {
    case todo
    case inProgress
