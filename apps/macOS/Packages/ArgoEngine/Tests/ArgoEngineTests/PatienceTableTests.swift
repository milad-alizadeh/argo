...
/// table that now owns it: what a raise puts on it, what an answer, a gone peer and a withdrawal
/// take off it, and the republish that follows every one of those.
///
/// The clock a raise arms alongside is `PatienceClockTests`.
///
