...
/// The two inputs the shipping shell's Work room needs besides the listing (#820) — a Binding to
...
extension CockpitPresentation {
    ...
    /// tickets `WorkFixture` spells `In progress`, so the rail's count is arithmetic over the room
