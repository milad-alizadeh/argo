...
/// get right (#861), the shapes of exchange a sequence layout has to (#862), the shapes of tree a
/// mindmap has to (#867) and the shapes of machine a state diagram has to (#863), each written the
