...
public struct ConnectPanelActions {
    ...
    /// Read one port through one Account, at one scope. All three travel together because a
    /// Binding is all three: an act that could set them separately could leave two of them
    /// pointing somewhere the third does not.
    public let bindPort: (AccountPort, String, String) -> Void
    ...
    public init(
        ...
        bindPort: @escaping (AccountPort, String, String) -> Void,
