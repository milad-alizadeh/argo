...
///
/// User-side language, not the model's: the panel says what the row will show you, and "Ticket
...
extension AccountPort {
    var readableName: String {
        switch self {
        case .ticket: "Issues and tickets"
    ...
    var benefit: String {
        switch self {
        case .ticket: "Connect an account to see your backlog beside your sessions."
