...
package enum DeviceCodeCopy {
    package static let copy = "Copy code"
    package static let copied = "Copied"
    package static let stop = "Stop waiting"
    package static let waiting = "Argo is waiting for you to finish in the browser."
    ...
    package static func heading(for challenge: ConnectChallenge) -> String {
    ...
    /// instruction.
    package static func address(of challenge: ConnectChallenge) -> String {
        switch challenge.kind {
    ...
    package static func spoken(_ challenge: ConnectChallenge) -> String {
        switch challenge.kind {
        case let .typed(code):
