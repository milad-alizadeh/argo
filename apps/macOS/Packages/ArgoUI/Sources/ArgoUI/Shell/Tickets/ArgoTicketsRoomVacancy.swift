...
/// What the Tickets room's vacancy panel is measured at (`docs/designs/cockpit-work-room.md` — the
/// room's own states). Beside the surface rather than in the contract: a measure read by one
/// surface is not a token (`apps/macOS/AGENTS.md`).
enum ArgoTicketsRoomVacancy {
