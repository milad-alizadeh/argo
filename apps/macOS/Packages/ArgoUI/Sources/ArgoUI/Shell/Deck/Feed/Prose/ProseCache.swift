...
struct ProseCache<Value> {
    ...
    /// transcripts' prose — see `ProseReading` for the two stores it applies to.
    let cap: Int
    ...
    mutating func hold(atLeast entries: Int) {
    ...
    struct ProseCacheCost {
        ...
        func hitRate(since opening: ProseCacheCost) -> Double {
