...
public extension ArgoMotion {
    ...
    /// The cap every role is held under, spent by `RhythmTests` rather than by a surface — a
    /// ceiling a call site could reach for would be a duration, which is the thing it forbids.
    ///
