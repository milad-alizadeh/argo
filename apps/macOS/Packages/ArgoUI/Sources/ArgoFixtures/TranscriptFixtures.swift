...
package enum TranscriptFixtures {
    ...
    package static func finished(_ id: String, _ result: ToolResult?) -> ToolCallOutcome {
        ToolCallOutcome(
            id: id,
    ...
    package static func printed(_ id: String, _ text: String) -> ToolCallOutcome {
    ...
    package static func launched(_ id: String, subagent: String) -> ToolCallOutcome {
        ToolCallOutcome(
            id: id,
            resolution: ToolCallOutcome.Resolution(
                status: .inProgress,
    ...
    package static func landed(_ id: String, tokens: Int, seconds: Int) -> ToolCallOutcome {
        spent(
            id,
            Usage(
                inputTokens: 0,
    ...
    package static func unwrapped(_ wrapped: String) -> String {
    ...
    package static func handedOver(_ secondsAgo: Int) -> Int {
