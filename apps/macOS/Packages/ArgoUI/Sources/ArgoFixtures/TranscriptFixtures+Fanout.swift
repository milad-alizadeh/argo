...
package extension TranscriptFixtures {
    /// The Subagent this transcript's one answered delegation names. Here rather than beside the
    /// rail's readings, because the id arrives in the record: the reading is keyed BY it.
