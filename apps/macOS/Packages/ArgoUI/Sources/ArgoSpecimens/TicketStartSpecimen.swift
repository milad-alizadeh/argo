...
/// which is the ticket whose labels REFUSE a command and opens an empty composer (#1182).
///
/// A specimen because no fixture reaches every state: `TicketsFixture` carries no ticket labelled
/// `wayfinder:*` or refused, and a specimen checkout has no `docs/designs/` to read.
