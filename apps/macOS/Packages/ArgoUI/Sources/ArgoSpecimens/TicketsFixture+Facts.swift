...
package extension TicketsFixture {
    ...
    static func reading(priorities edit: (inout [Int: String]) -> Void) -> TicketsReading {
    ...
    /// The bodies, on the four tickets a render opens on. Every other ticket carries none, which
    /// is the ordinary case: a listing answers with what the provider filed, and most of it is
    /// empty.
    static let bodies: [Int: String] = [
        272: body, 388: everyBlockBody, 607: parentBody, 609: screenshotBody,
    ]
