...
public struct MermaidDiagram: Equatable, Sendable {
    ...
    public static func read(_ source: String) -> MermaidDiagram? {
    ...
    /// The diagram laid out. Uncached: callers come through `plan`, which is the one layout the
    /// renderer and the lane share.
    ///
...
public extension MermaidDiagram {
