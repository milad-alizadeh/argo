...
/// The one tile of noise the grain is spent from — `atlas_grain` in `AtlasVolume.metal` is what
/// spends it (#1600).
///
...
/// measure.
enum AtlasGrain {
    /// How wide the tile is on each side, in pixels of the drawable: the design's own 96.
    ///
