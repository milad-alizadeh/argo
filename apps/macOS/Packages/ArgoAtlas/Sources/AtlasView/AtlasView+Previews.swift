...
// The map as a picture: every state of it worth looking at, and the one plan they are all drawn
// from. Their own file rather than the foot of `AtlasView.swift`, which the map outgrew once its
// moves landed — a preview is a still OF the view rather than a part of it, and eleven of them
// were most of what the file was.
