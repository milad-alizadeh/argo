...
/// together because they are one reading and because the drawing joins them: the open file's own
...
///
/// The name is the palette's: `atlas.marks` is the family a cord's colour comes from, and this is
