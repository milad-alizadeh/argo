...
**Scope: #812, #815, #818 and #816** — the views sidebar, the flat backlog list and the ticket
(#812), then the ticket's fact strip and its three sections (#815), then the room's two vacancy
pages (#818), then the room's toolbar row (#816, its own section at the foot). The design freezes
31 names across the whole room; the twenty-four below are the ones these tickets built. The rest
(the hero, the tree, the Route) belong to their own tickets and are absent rather than stubbed.
