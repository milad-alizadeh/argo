...
| `cockpit-session-composer.inventory.md` | Composer build inventory | What each ticket's build extracted from the design, one row per component, through #1692's New Session flow, provider marks and harness-specific run controls |
