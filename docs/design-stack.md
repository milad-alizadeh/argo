...
- **Token contract** — `apps/desktop/src/renderer/tokens.css`. All design tokens live there.
...
- **Session UI source** — `composer-prototype.tsx` and its local subtree at commit
  `602bcce21d33d9d122fe3d2ae9bfaef33de1eb3c` on `argo/#1258-session-prototype-source`.
  The entry file is `apps/desktop/src/renderer/modules/composer-prototype/composer-prototype.tsx`.
