...
- **Components live in** — `apps/desktop/src/platform/renderer/components/ui/`, written by the shadcn CLI
  and never hand-edited, and `apps/desktop/src/platform/renderer/components/`, written here. A shape the
